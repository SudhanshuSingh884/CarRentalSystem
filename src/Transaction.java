...
public class Transaction {
    ...
    public void setTransaction(Customer cU, Car cA, String m, int d, int y, String pM, int pD, int pY, String rM,
            int rD, int rY, String bM, int bD, int bY) { // constructor
        aCustomer = cU;
        aCar = cA;
        CurrentMonth = m;
        CurrentDate = d;
    ...
    /////////////////////// for getting How many days Car has been
    /////////////////////// rented/////////////////
    public int getDays() {
    ...
    ////////////////////////////////////// change to String for checking the
    ////////////////////////////////////// date////////////////////////
    public String toStringDateChecker() {
        ...
        if ((getPickMonthValue() == getReturnMonthValue()) && (getPickDate() > getReturnDate())
                && (getPickYear() == getReturnYear()))
            outpot += String.format("FALSE");
    ...
    ////////////////////////////////////////// change to String for checking the age
    ////////////////////////////////////////// of customer/////////////////////
    ...
    ////////////////////////////// (int)age to (String)age to print in
    ////////////////////////////// GUI/////////////////////
    ...
    public String toStringMrMrs() {
        ...
        else if ((aCustomer.getStatus().equals("S") || aCustomer.getStatus().equals("s"))
                && aCustomer.getGender().equals("F") || aCustomer.getGender().equals("f"))
            outfowt += String.format("Ms.");

        else if ((aCustomer.getStatus().equals("Ma") || aCustomer.getStatus().equals("ma"))
                && aCustomer.getGender().equals("F") || aCustomer.getGender().equals("f"))
    ...
    public String toStringReceipt() {
        ...
        outMe += String.format("               	             NITJ Car Rental\n");
        outMe += String.format("                              Owned & Operated By:\n");
        outMe += String.format("                             INFORMATION TECHNOLOGY\n");
    ...
    //////////////////////////////////////////// save all data to .txt file for the
    //////////////////////////////////////////// Owner//////////////////////////////
    public void saveToFile() throws IOException {
        ...
        outFile.println("Return Date: " + getReturnMonth() + " " + getReturnDate() + ", " + getReturnYear()
                + " = Days: " + getDays());
