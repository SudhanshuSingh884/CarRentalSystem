...
public class RentalView extends JFrame {
    ...
    private JPanel mainP, reserveP, customerP, carP, finalP, thankP; // panels for CardLayout
    ...
    private JComboBox pUMCB, pUDCB, pUYCB, rMCB, rDCB, rYCB,
            bMCB, bDCB, bYCB, genderTF;
    private JLabel dateChecker, ageChecker;
    private JButton reserveNextB, reserveBackB;

    //////////////////////////////////////////////// customer
    //////////////////////////////////////////////// info//////////////////////////////////////
    private JLabel customerL, firstNameL, lastNameL, locationL, contactL, genderL, ageL, showAgeL; // inside the panel
                                                                                                   // of customerP
    private JTextField firstNameTF, lastNameTF, locationTF, contactTF;
    ...
    private JButton thankB;

    /////////////////////////////////////////////// thank
    /////////////////////////////////////////////// you/////////////////////////////////////
    private JLabel thankL;
    private JTextArea thankTA;
    ...
    public RentalView() {
        ...
        ImageIcon titleImage = new ImageIcon("../images/logo2.png");
        ...
        reserveP.setBackground(Color.CYAN);
        ...
        Integer[] pickUpYearCB = { 2023, 2024, 2025, 2026 };
        ...
        Integer[] returnYearCB = { 2023, 2024, 2025, 2026 };
        ...
        ImageIcon dateBackImage = new ImageIcon("../images/lo5.png");
        ...
        customerP.setBackground(Color.CYAN);
        ...
        locationL.setBounds(50, 180, 250, 30);
        ...
        showAgeL.setBounds(145, 260, 60, 30);
        ...
        customerBackB.setBounds(360, 300, 100, 50);
        ...
        // -----------------------------------TEXT AREA for pick a car putting details
    ...
    private class firstNameTF implements ActionListener {
        public void actionPerformed(ActionEvent event) {
    ...
    private class reserveNextButton implements ActionListener {
        public void actionPerformed(ActionEvent event) {
            ...
            if (event.getActionCommand().equals("NextToCustomer")) {
                ...
                if (!aTrans.toStringDateChecker().equals("TRUE")) { // check if valid or not for pick date and return
                                                                    // date
    ...
    private class customerNextButton implements ActionListener {
        public void actionPerformed(ActionEvent event) {
            ...
            if (event.getActionCommand().equals("NextToPickCar")) {
                ...
                gender = genderTF.getSelectedItem().toString();
                ...
                if (!aCustomer.getFirstName().matches("[a-zA-Z]+")) { // checker for firstname if empty , its
                    // invalid
                ...
                if (!aCustomer.getLastName().matches("[a-zA-Z]+")) { // for last name
                ...
                // genderChecker.setBounds(230, 135, 50, 20);
                // genderChecker.setText("Valid");
                // }

                if (!aCustomer.getLocation().matches("[a-zA-Z]+")) { // for location
                ...
                if (!aCustomer.getContact().matches("[0-9]{10}")) { // for contact
                ...
                if (aCustomer.getFirstName().matches("[a-zA-Z]+")
                        && aCustomer.getLastName().matches("[a-zA-Z]+")

                        && aCustomer.getLocation().matches("[a-zA-Z]+")

                        && aCustomer.getContact().matches("[0-9]{10}")) {
                    // if all of the above is valid ,
